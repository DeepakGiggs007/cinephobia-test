...
var ids = {
    facebook: {
        ...
        callbackURL: process.env.FB_CALLBACK || "http://localhost:3000/auth/facebook/callback"
        //"http://cinephobia.herokuapp.com/auth/facebook/callback"     
    },
    twitter: {
        ...
        //"http://cinephobia.herokuapp.com/auth/twitter/callback",
